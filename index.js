...
const { fetchHackerNewsStories } = require('./services/hackerNewsScraper');
const apiRoutes = require('./Backend/api');
const db = require('./DataBase/database');
const { server_start_time } = require('./services/timer');
const { updatePublishedStoriesCount } = require('./services/counter');
